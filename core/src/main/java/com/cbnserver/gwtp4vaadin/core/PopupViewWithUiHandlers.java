...
public abstract class PopupViewWithUiHandlers<C extends UiHandlers> extends
    ...
    /**
     * The {@link PopupViewWithUiHandlers} class uses the {@link MVPEventBus} to listen to
     * {@link com.cbnserver.gwtp4vaadin.core.proxy.NavigationEvent} in order to automatically
