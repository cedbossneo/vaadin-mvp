 ...
 * {@link com.cbnserver.gwtp4vaadin.core.proxy.ProxyPlace ProxyPlace}. Then you should apply various
 ...
 * <p/>
 * To reveal a presenter associated to a {@link com.cbnserver.gwtp4vaadin.core.proxy.ProxyPlace ProxyPlace}
 * you can simply navigate to an hyperlink corresponding to this place's name token. The
 * {@link com.cbnserver.gwtp4vaadin.core.proxy.PlaceManager PlaceManager} offers a number of method for building
 * such hyperlinks. If you want to reveal it programatically, you should build a
 * {@link com.cbnserver.gwtp4vaadin.core.proxy.PlaceRequest PlaceRequest} and call one of the
 * following method:
 * <ul>
 * <li>{@link com.cbnserver.gwtp4vaadin.core.proxy.PlaceManager#revealPlace(com.cbnserver.gwtp4vaadin.core.proxy.PlaceRequest)}
 * PlaceManager.revealPlace(PlaceRequest)}</li>
 * <li>{@link com.cbnserver.gwtp4vaadin.core.proxy.PlaceManager#revealRelativePlace(com.cbnserver.gwtp4vaadin.core.proxy.PlaceRequest)}
 * PlaceManager.revealRelativePlace(PlaceRequest)}</li>
 * <li>{@link com.cbnserver.gwtp4vaadin.core.proxy.PlaceManager#revealRelativePlace(com.cbnserver.gwtp4vaadin.core.proxy.PlaceRequest, int)}
 ...
 * using the {@link com.cbnserver.gwtp4vaadin.core.annotations.ProxyEvent ProxyEvent}
 * mechanism.
 * <p/>
 ...
 * {@link com.cbnserver.gwtp4vaadin.core.proxy.PlaceManager PlaceManager} method):
 * <ul>
 * <li>The presenter's {@link #revealInParent()} is call and it asks to be set in one of its
 * parent slot by firing a
 * {@link com.cbnserver.gwtp4vaadin.core.proxy.RevealContentEvent RevealContentEvent}</li>
 ...
 * by firing a {@link com.cbnserver.gwtp4vaadin.core.proxy.RevealContentEvent RevealContentEvent}
 * too, this continues recursively until a visible presenter is reached, or until a presenter fires
 * {@link com.cbnserver.gwtp4vaadin.core.proxy.RevealRootContentEvent RevealRootContentEvent}
 * or {@link com.cbnserver.gwtp4vaadin.core.proxy.RevealRootLayoutContentEvent RevealRootLayoutContentEvent}</li>
 * </ul>
...
public abstract class Presenter<V extends View, Proxy_ extends Proxy<?>> extends PresenterWidget<V> {
     ...
     */
    public Presenter(boolean autoBind, MVPEventBus eventBus, V view, Proxy_ proxy) {
        super(eventBus, view);
        this.proxy = proxy;
    }
     ...
     * @param proxy    The {@link Proxy}.
     */
    public Presenter(MVPEventBus eventBus, V view, Proxy_ proxy) {
     ...
     * Since this method bypasses the {@link com.cbnserver.gwtp4vaadin.core.proxy.PlaceManager PlaceManager}
     * it will not:
     * <ul>
     * <li>Update the browser history</li>
     * <li>Check accessibility via the {@link com.cbnserver.gwtp4vaadin.core.proxy.Gatekeeper Gatekeeper}</li>
     * <li>Setup the presenter via {@link #prepareFromRequest(PlaceRequest)}</li>
     * <li>Uses the leave confirmation mechanism (see {@link com.cbnserver.gwtp4vaadin.core.proxy
     * .PlaceManager#setOnLeaveConfirmation(String) PlaceManager.setOnLeaveConfirmation})</li>
     * </ul>
     * Therefore, to reveal a presenter associated to a {@link com.cbnserver.gwtp4vaadin.core.proxy.ProxyPlace ProxyPlace}
     * use one of the method provided by the {@link com.cbnserver.gwtp4vaadin.core.proxy.PlaceManager PlaceManager}.
     ...
     * <ul>
     * <li> Fetch the data using a {@link com.cbnserver.gwtp4vaadin.core.proxy.ManualRevealCallback ManualRevealCallback},
     * which will automatically reveal the presenter upon success.</li>
     * <li> Fetch the data by any other mean and call
     * {@link com.cbnserver.gwtp4vaadin.core.proxy.ProxyPlace#manualReveal(Presenter)} when
     * your data is available. In this case you also have to call
     * {@link com.cbnserver.gwtp4vaadin.core.proxy.ProxyPlace#manualRevealFailed()}
     ...
     * {@link com.cbnserver.gwtp4vaadin.core.proxy.PlaceManager PlaceManager} navigates
     ...
     * {@link com.cbnserver.gwtp4vaadin.core.proxy.RevealContentEvent RevealContentEvent},
     * a {@link com.cbnserver.gwtp4vaadin.core.proxy.RevealRootContentEvent RevealRootContentEvent}
     * or a {@link com.cbnserver.gwtp4vaadin.core.proxy.RevealRootLayoutContentEvent RevealRootLayoutContentEvent}.
     */
