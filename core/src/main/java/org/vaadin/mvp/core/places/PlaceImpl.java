...
package org.vaadin.mvp.core.places;
...
public class PlaceImpl implements Place {
  ...
  @Override
  public final boolean matchesRequest(ViewChangeListener.ViewChangeEvent request) {
    return request.getViewName().equals(getNameToken());
  }
