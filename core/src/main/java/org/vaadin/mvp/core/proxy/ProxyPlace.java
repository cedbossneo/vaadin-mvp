...
/**
 * The interface of a {@link Proxy} that is also a {@link org.vaadin.mvp.core.places.Place}.
 *
...
public interface ProxyPlace<P extends Presenter<?>> extends Proxy<P>, Place, View {
   ...
   * to use manual reveal via {@link org.vaadin.mvp.core.presenters.Presenter#useManualReveal()}. This method should be
   * called following one or more asynchronous server calls in
   * {@link org.vaadin.mvp.core.presenters.Presenter#prepareFromRequest(PlaceRequest)}.
   ...
   * {@link #manualReveal(org.vaadin.mvp.core.presenters.Presenter)} upon success and {@link #manualRevealFailed()} upon
   * failure.
   *
   * @see org.vaadin.mvp.core.presenters.Presenter#useManualReveal()
   ...
   * to use manual reveal via {@link org.vaadin.mvp.core.presenters.Presenter#useManualReveal()}. For more details see
   * {@link #manualReveal(org.vaadin.mvp.core.presenters.Presenter)}.
   *
   * @see #manualReveal(org.vaadin.mvp.core.presenters.Presenter)
   */
