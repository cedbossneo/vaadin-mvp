 ...
 *         {@link org.vaadin.mvp.core.events.RevealContentEvent RevealContentEvent}.
 ...
 * </ul>
 *
 * @param <V> The {@link org.vaadin.mvp.core.views.View} type.
 *
...
public abstract class  PresenterWidget<V extends View> extends
  ...
  /**
   * Returns the {@link org.vaadin.mvp.core.views.View} for the current presenter.
   *
   * @return The view.
   */
  public V getView() {
   ...
   * you override. Also, do not call directly, fire a {@link org.vaadin.mvp.core.events.ResetPresentersEvent}
   ...
   * fire a {@link org.vaadin.mvp.core.events.ResetPresentersEvent} to perform a reset manually.
   */
  void internalReset() {
    onReset();
    for (List<PresenterWidget<?>> slotChildren : activeChildren.values()) {
