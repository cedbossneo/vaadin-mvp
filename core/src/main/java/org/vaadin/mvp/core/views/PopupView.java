...
public interface PopupView extends View {
  ...
  /**
   * Make sure the {@link org.vaadin.mvp.client.views.PopupView} is centered in the browser's client area.
  ...
  /**
   * Make sure the {@link org.vaadin.mvp.client.views.PopupView} is hidden. You can call this method
   * directly.
   */
  void hide();
  ...
  /**
   * Reposition the {@link org.vaadin.mvp.client.views.PopupView} within the browser's client area. This
   ...
   * <p/>
   * Make sure the {@link org.vaadin.mvp.client.views.PopupView} is visible.
   */
  void show();
