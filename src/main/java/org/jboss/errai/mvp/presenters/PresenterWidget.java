...
package org.jboss.errai.mvp.presenters;
...
import org.jboss.errai.mvp.events.ResetPresentersEvent;
import org.jboss.errai.mvp.views.PopupView;
import org.jboss.errai.mvp.views.PopupViewCloseHandler;
 ...
 * application will usually be singletons and extend the {@link org.jboss.errai.mvp.presenters.Presenter} class.
 * <p />
 * Choosing between a {@link org.jboss.errai.mvp.presenters.Presenter} and {@link PresenterWidget} is a design decision that
 * requires some thought. For example, a {@link PresenterWidget} is useful when
 * you need a custom component with extensive logic. For example, a chat box that can be instantiated
 ...
 * parent presenter, which increases coupling. Therefore, you should use a {@link org.jboss.errai.mvp.presenters.Presenter} when
 * the parent is not expected to know its child. Moreover, only {@link org.jboss.errai.mvp.presenters.Presenter} can be attached
 * to name tokens in order to support browser history.
 * <p />
 * {@link PresenterWidget}s and {@link org.jboss.errai.mvp.presenters.Presenter}s are organized in a hierarchy.
 * Internally, parent presenters have links to their currently attached children presenters. A
 * parent {@link org.jboss.errai.mvp.presenters.Presenter} can contain either {@link org.jboss.errai.mvp.presenters.Presenter}s or {@link PresenterWidget}s,
 * but a {@link PresenterWidget} can only contain {@link PresenterWidget}s.
 * <p />
 * To reveal a {@link PresenterWidget} you should insert it within a {@link org.jboss.errai.mvp.presenters.HasSlots slot} of its
 ...
 * </ul>
 * Revealing a {@link org.jboss.errai.mvp.presenters.Presenter} is done differently, refer to the class documentation for more details.
 * <p />
 * To hide a {@link PresenterWidget} or a {@link org.jboss.errai.mvp.presenters.Presenter} you can use {@link #setInSlot} to place
 ...
 * </ul>
 * Hide a {@link org.jboss.errai.mvp.presenters.Presenter} using these methods, but
 * <p />
 ...
 *     <li>If the parent is not visible and is a {@link org.jboss.errai.mvp.presenters.Presenter}, it asks to be
 *         set in one of its parent slot by firing a
 *         {@link org.jboss.errai.mvp.events.RevealContentEvent RevealContentEvent}.
 *         For more details, see the documentation for {@link org.jboss.errai.mvp.presenters.Presenter}.</li>
 * </ul>
 ...
 * </ul>
 *
 * @param <V> The {@link org.jboss.errai.mvp.views.View} type.
 *
...
public abstract class  PresenterWidget<V extends View> extends
  ...
  /**
   * The parent presenter, in order to make sure this component is only ever in one
   * parent.
   */
   ...
   * {@link org.jboss.errai.mvp.presenters.HandlerContainerImpl#HandlerContainerImpl(boolean)} for
   ...
   * @param view The {@link org.jboss.errai.mvp.views.View}.
   */
   ...
   * See {@link org.jboss.errai.mvp.presenters.HandlerContainerImpl#HandlerContainerImpl()} for more details on
   * automatic binding.
   *
   * @param eventBus The {@link com.google.web.bindery.event.shared.EventBus}.
   * @param view The {@link org.jboss.errai.mvp.views.View}.
  ...
  public final void addToSlot(Object slot, PresenterWidget<?> content) {
    ...
    getView().addToSlot(slot, content.getComponent());
    if (isVisible()) {
      // This presenter is visible, its time to call onReveal
      // on the newly added child (and recursively on this child children)
  ...
  /**
   * Returns the {@link org.jboss.errai.mvp.views.View} for the current presenter.
   *
   * @return The view.
   */
  public V getView() {
  ...
  public Component getComponent() {
    return (getView() == null) ? null : getView().asComponent();
  }
  ...
  public final void removeFromSlot(Object slot, PresenterWidget<?> content) {
    ...
    getView().removeFromSlot(slot, content.getComponent());
  }
  ...
  public final void setInSlot(Object slot, PresenterWidget<?> content,
    ...
    getView().setInSlot(slot, content.getComponent());
    if (isVisible()) {
      // This presenter is visible, its time to call onReveal
      // on the newly added child (and recursively on this child children)
   ...
   * you override. Also, do not call directly, fire a {@link org.jboss.errai.mvp.events.ResetPresentersEvent}
   ...
   * See {@link PresenterWidget} and {@link org.jboss.errai.mvp.presenters.Presenter} for ways to reveal a
   * presenter.
   */
  void internalReveal() {
   ...
   * fire a {@link org.jboss.errai.mvp.events.ResetPresentersEvent} to perform a reset manually.
   */
  void internalReset() {
    onReset();
    for (List<PresenterWidget<?>> slotChildren : activeChildren.values()) {
