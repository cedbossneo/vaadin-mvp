...
public abstract class Presenter<V extends View> extends PresenterWidget<V> implements com.vaadin.navigator.View{
   ...
   * <li>Setup the presenter via {@link #prepareFromRequest(org.jboss.errai.mvp.places.PlaceRequest)}</li>
   ...
   * received. Fetching this data should be done in the {@link #prepareFromRequest(org.jboss.errai.mvp.places.PlaceRequest)}
   * method.
   * <p />
   ...
   *      {@link org.jboss.errai.mvp.proxy.ProxyPlace#manualReveal(Presenter)} when
   *      your data is available. In this case you also have to call
   *      {@link org.jboss.errai.mvp.proxy.ProxyPlace#manualRevealFailed()}
   ...
   * or a {@link org.jboss.errai.mvp.events.RevealRootContentEvent RevealRootContentEvent}
   */
