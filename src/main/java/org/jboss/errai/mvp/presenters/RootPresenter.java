 ...
 * from presenter component, but it's just because it doesn't need a proxy has it
 ...
 * <p />
 * Fire a {@link org.jboss.errai.mvp.events.RevealRootContentEvent}
...
public class RootPresenter extends
    PresenterWidget<RootPresenter.MyView> implements
        ...
        LockInteractionHandler , Serializable{

  public static Object rootSlot = new Object();
