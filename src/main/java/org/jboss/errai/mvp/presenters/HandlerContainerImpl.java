...
/**
 * The implementation of {@link org.jboss.errai.mvp.presenters.HandlerContainer}. Inherit from this class if
...
public class HandlerContainerImpl implements HandlerContainer {
   ...
   * {@link org.jboss.errai.mvp.presenters.AutobindDisable} is used to globally disable automatic
   * binding.
   * <p />
   ...
   * injection mechanism, unless {@link org.jboss.errai.mvp.presenters.AutobindDisable} is used to globally
   ...
   * injection mechanism so that {@link org.jboss.errai.mvp.presenters.AutobindDisable} can be used to
   * globally turn off automatic binding.
   */
  void automaticBind(AutobindDisable autobindDisable) {
