...
/**
 * The interface of a {@link Proxy} that is also a {@link org.jboss.errai.mvp.places.Place}.
 *
 * @param <P> The type of the {@link org.jboss.errai.mvp.presenters.Presenter} associated with this proxy.
 *
...
public interface ProxyPlace<P extends Presenter<?>> extends Proxy<P>, Place {
   ...
   * to use manual reveal via {@link org.jboss.errai.mvp.presenters.Presenter#useManualReveal()}. This method should be
   * called following one or more asynchronous server calls in
   * {@link org.jboss.errai.mvp.presenters.Presenter#prepareFromRequest(PlaceRequest)}.
   ...
   * {@link #manualReveal(org.jboss.errai.mvp.presenters.Presenter)} upon success and {@link #manualRevealFailed()} upon
   * failure.
   *
   * @see org.jboss.errai.mvp.presenters.Presenter#useManualReveal()
   ...
   * to use manual reveal via {@link org.jboss.errai.mvp.presenters.Presenter#useManualReveal()}. For more details see
   * {@link #manualReveal(org.jboss.errai.mvp.presenters.Presenter)}.
   *
   * @see #manualReveal(org.jboss.errai.mvp.presenters.Presenter)
   */
