...
import org.jboss.errai.mvp.events.*;
 ...
 * You can usually inherit from the simpler form {@link org.jboss.errai.mvp.proxy.ProxyPlace}.
 * <p />
 *
...
public class ProxyPlaceAbstract<P extends Presenter<?>, Proxy_ extends Proxy<P>>
  ...
  /**
   * Creates a {@link org.jboss.errai.mvp.proxy.ProxyPlaceAbstract}. That is, the {@link Proxy} of a
   ...
   * title.
   *
   * @param event The {@link org.jboss.errai.mvp.events.GetPlaceTitleEvent} to invoke once the title is
   *          available.
   */
