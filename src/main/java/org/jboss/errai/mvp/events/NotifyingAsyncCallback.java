 ...
 *
 * So the way to use {@link org.jboss.errai.mvp.events.NotifyingAsyncCallback} is the following:
 * <pre>
...
public abstract class NotifyingAsyncCallback<T> implements AsyncCallback<T> {
   ...
   * {@link org.jboss.errai.mvp.events.NotifyingAsyncCallback} for usage.
   */
  public void prepare() {
   ...
   * success). See {@link org.jboss.errai.mvp.events.NotifyingAsyncCallback} for usage.
   */
