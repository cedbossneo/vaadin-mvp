 ...
 * {@link org.jboss.errai.mvp.places.PlaceRequest}.
 *
...
public final class NavigationEvent extends GwtEvent<NavigationHandler> {
   ...
   * @param request The {@link org.jboss.errai.mvp.places.PlaceRequest} that was navigated to.
   */
   ...
   *
   * @param request The {@link org.jboss.errai.mvp.places.PlaceRequest}.
   */
  ...
  /**
   * Access the {@link org.jboss.errai.mvp.places.PlaceRequest} that triggered that navigation event.
   *
   * @return The {@link org.jboss.errai.mvp.places.PlaceRequest} or {@code null} if no place request is
   *         known.
   */
