 ...
 * {@link PlaceManager#getCurrentTitle(org.jboss.errai.mvp.events.SetPlaceTitleHandler)} or
 * {@link PlaceManager#getTitle(int, org.jboss.errai.mvp.events.SetPlaceTitleHandler)}.
 *
...
public class GetPlaceTitleEvent extends GwtEvent<GetPlaceTitleHandler> {
   ...
   * @param request The {@link org.jboss.errai.mvp.places.PlaceRequest} for which to obtain the title.
   * @param handler The {@link org.jboss.errai.mvp.events.SetPlaceTitleHandler} that will be invoked when
