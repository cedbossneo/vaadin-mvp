 ...
 * You can usually inherit from the simpler form {@link org.vaadin.mvp.proxy.ProxyPlace}.
 * <p />
 *
...
public class ProxyPlaceAbstract<P extends Presenter<?>, Proxy_ extends Proxy<P>>
  ...
  /**
   * Creates a {@link org.vaadin.mvp.proxy.ProxyPlaceAbstract}. That is, the {@link Proxy} of a
   ...
   * title.
   *
   * @param event The {@link org.vaadin.mvp.events.GetPlaceTitleEvent} to invoke once the title is
   *          available.
   */
