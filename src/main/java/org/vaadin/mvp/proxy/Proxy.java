 ...
 * others, the presenter's specific {@link org.vaadin.mvp.events.RevealContentEvent} that needs the
 * presenter to reveal itself.
 * <p />
 * The relationship between a presenter and its proxy is two-way.
 * <p />
 * {@link org.vaadin.mvp.presenters.Presenter} subclasses will usually define their own interface called
...
public interface Proxy<P extends Presenter<?>> extends HasHandlers {
  ...
  /**
   * Get the associated {@link org.vaadin.mvp.presenters.Presenter}. The presenter can only be obtained in
   * an asynchronous manner to support code splitting when needed. To access the
   * presenter, pass a callback.
   *
   * @param callback The callback in which the {@link org.vaadin.mvp.presenters.Presenter} will be passed
   *          as a parameter.
   */
