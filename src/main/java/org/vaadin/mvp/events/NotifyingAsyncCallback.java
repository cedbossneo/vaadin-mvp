 ...
 *
 * So the way to use {@link org.vaadin.mvp.events.NotifyingAsyncCallback} is the following:
 * <pre>
...
public abstract class NotifyingAsyncCallback<T> implements AsyncCallback<T> {
   ...
   * {@link org.vaadin.mvp.events.NotifyingAsyncCallback} for usage.
   */
  public void prepare() {
   ...
   * success). See {@link org.vaadin.mvp.events.NotifyingAsyncCallback} for usage.
   */
