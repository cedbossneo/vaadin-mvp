...
public abstract class Presenter<V extends View> extends PresenterWidget<V> implements com.vaadin.navigator.View{
   ...
   * <li>Setup the presenter via {@link #prepareFromRequest(org.vaadin.mvp.places.PlaceRequest)}</li>
   ...
   * received. Fetching this data should be done in the {@link #prepareFromRequest(org.vaadin.mvp.places.PlaceRequest)}
   * method.
   * <p />
   ...
   *      {@link org.vaadin.mvp.proxy.ProxyPlace#manualReveal(Presenter)} when
   *      your data is available. In this case you also have to call
   *      {@link org.vaadin.mvp.proxy.ProxyPlace#manualRevealFailed()}
   ...
   * or a {@link org.vaadin.mvp.events.RevealRootContentEvent RevealRootContentEvent}
   */
