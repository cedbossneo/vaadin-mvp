...
import org.vaadin.mvp.events.ResetPresentersEvent;
import org.vaadin.mvp.views.PopupView;
import org.vaadin.mvp.views.PopupViewCloseHandler;
 ...
 * application will usually be singletons and extend the {@link org.vaadin.mvp.presenters.Presenter} class.
 * <p />
 * Choosing between a {@link org.vaadin.mvp.presenters.Presenter} and {@link PresenterWidget} is a design decision that
 ...
 * parent presenter, which increases coupling. Therefore, you should use a {@link org.vaadin.mvp.presenters.Presenter} when
 * the parent is not expected to know its child. Moreover, only {@link org.vaadin.mvp.presenters.Presenter} can be attached
 * to name tokens in order to support browser history.
 * <p />
 * {@link PresenterWidget}s and {@link org.vaadin.mvp.presenters.Presenter}s are organized in a hierarchy.
 * Internally, parent presenters have links to their currently attached children presenters. A
 * parent {@link org.vaadin.mvp.presenters.Presenter} can contain either {@link org.vaadin.mvp.presenters.Presenter}s or {@link PresenterWidget}s,
 * but a {@link PresenterWidget} can only contain {@link PresenterWidget}s.
 * <p />
 * To reveal a {@link PresenterWidget} you should insert it within a {@link org.vaadin.mvp.presenters.HasSlots slot} of its
 ...
 * </ul>
 * Revealing a {@link org.vaadin.mvp.presenters.Presenter} is done differently, refer to the class documentation for more details.
 * <p />
 * To hide a {@link PresenterWidget} or a {@link org.vaadin.mvp.presenters.Presenter} you can use {@link #setInSlot} to place
 ...
 * </ul>
 * Hide a {@link org.vaadin.mvp.presenters.Presenter} using these methods, but
 * <p />
 ...
 *     <li>If the parent is not visible and is a {@link org.vaadin.mvp.presenters.Presenter}, it asks to be
 *         set in one of its parent slot by firing a
 *         {@link org.vaadin.mvp.events.RevealContentEvent RevealContentEvent}.
 *         For more details, see the documentation for {@link org.vaadin.mvp.presenters.Presenter}.</li>
 * </ul>
 ...
 * </ul>
 *
 * @param <V> The {@link org.vaadin.mvp.views.View} type.
 *
...
public abstract class  PresenterWidget<V extends View> extends
   ...
   * {@link org.vaadin.mvp.presenters.HandlerContainerImpl#HandlerContainerImpl(boolean)} for
   ...
   * @param view The {@link org.vaadin.mvp.views.View}.
   */
   ...
   * See {@link org.vaadin.mvp.presenters.HandlerContainerImpl#HandlerContainerImpl()} for more details on
   * automatic binding.
   *
   * @param eventBus The {@link com.google.web.bindery.event.shared.EventBus}.
   * @param view The {@link org.vaadin.mvp.views.View}.
  ...
  /**
   * Returns the {@link org.vaadin.mvp.views.View} for the current presenter.
   *
   * @return The view.
   */
  public V getView() {
   ...
   * you override. Also, do not call directly, fire a {@link org.vaadin.mvp.events.ResetPresentersEvent}
   ...
   * See {@link PresenterWidget} and {@link org.vaadin.mvp.presenters.Presenter} for ways to reveal a
   * presenter.
   */
  void internalReveal() {
   ...
   * fire a {@link org.vaadin.mvp.events.ResetPresentersEvent} to perform a reset manually.
   */
  void internalReset() {
    onReset();
    for (List<PresenterWidget<?>> slotChildren : activeChildren.values()) {
